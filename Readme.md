...
export interface IPlayerAnalyticsConnectorInitOptions {
  ...
  heartbeatInterval?: number; // Defaults to 30000 (ms)
}
```
...
Low-level API implementing the [EPAS PlayerAnalyticsClientModule](https://github.com/Eyevinn/player-analytics-specification) interface. Each method accepts a full EPAS event object.
